 ...
 * @subpackage Block
 */
class Studioforty9_Gallery_Block_Adminhtml_Album_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    /**
    ...
    protected function _construct()
    {
        ...
        $this->setTitle($this->_getHelper()->__('Album'));
    }
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            'label'   => $this->_getHelper()->__('Album Content'),
            'title'   => $this->_getHelper()->__('Album Content'),
            'content' => $this->getLayout()->createBlock(
                'studioforty9_gallery/adminhtml_album_edit_tab_form'
            )->toHtml(),
        ));
        ...
        $this->addTab('meta_section', array(
            ...
            'content' => $this->getLayout()->createBlock(
                'studioforty9_gallery/adminhtml_album_edit_tab_meta'
            )->toHtml(),
        ));

        $this->addTab('grid_section', array(
            'label'   => $this->_getHelper()->__('Associated Media'),
            'title'   => $this->_getHelper()->__('Associated Media'),
            'url'       => $this->getUrl('*/*/mediatab', array('_current' => true)),
            'class'     => 'ajax'
        ));
