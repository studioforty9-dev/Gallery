...
/**
 * Studioforty9_Gallery_Block_Adminhtml_Album_Edit_Tab_Meta
 *
 * @category   Studioforty9
 * @package    Studioforty9_Gallery
 * @subpackage Block
 */
class Studioforty9_Gallery_Block_Adminhtml_Album_Edit_Tab_Meta extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * _prepareForm()
     *
