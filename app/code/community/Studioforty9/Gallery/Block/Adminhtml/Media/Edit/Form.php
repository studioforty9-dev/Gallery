...
/**
 * Studioforty9_Gallery_Block_Adminhtml_Media_Edit_Form
 *
 * @category   Studioforty9
 * @package    Studioforty9_Gallery
 * @subpackage Block
 */
class Studioforty9_Gallery_Block_Adminhtml_Media_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
