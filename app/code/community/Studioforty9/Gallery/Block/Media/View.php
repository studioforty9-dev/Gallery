...
/**
 * Studioforty9_Gallery_Block_Media_View
 *
 * @category   Studioforty9
 * @package    Studioforty9_Gallery
 * @subpackage Block
 */
class Studioforty9_Gallery_Block_Media_View extends Mage_Core_Block_Template
{
    /**
    ...
    {
        $this->setAlbum(Mage::registry('current_album'));
        $this->setMedia(Mage::registry('current_media'));
    }
}
